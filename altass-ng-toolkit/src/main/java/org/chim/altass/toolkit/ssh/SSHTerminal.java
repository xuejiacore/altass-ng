...
//        configTerminal("BUFFER_SIZE", BUFFER_SIZE);
    ...
    public SSHTerminal confSession(String host, String user, String pwd) throws JSchException {
        return confSession(host, 22, user, pwd);
    }

    public SSHTerminal confSession(String host, Integer port, String user, String pwd) throws JSchException {
        return confSession(new SSHInfo(host, user, pwd, port));
    }
...
//            sshTerminal.confSession("115.28.40.152", "zhanxuejia", "ikezhanxuejia!@#")
            sshTerminal.confSession("127.0.0.1", "jchim", "yanziguiiszxj29")
...
//                    .openChannel();
            ...
            sshTerminal.execCmd("tail -f /data/eureka/test_data_source/mop_conf_api.txt");
